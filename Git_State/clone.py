...
with open('LeetCode-Record-Sharing-Method_clone.json', 'r') as fh: now = json.load(fh)
with open('LeetCode-Record-Sharing-Method_clone_before.json', 'r') as fh: before = json.load(fh)
...
with open('LeetCode-Record-Sharing-Method_clone.json', 'w', encoding='utf-8') as fh: json.dump(latest, fh, ensure_ascii=False, indent=4)